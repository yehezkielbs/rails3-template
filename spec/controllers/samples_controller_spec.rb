  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved sample as @sample" do
        ...
        post :create, {:sample => { "name" => "invalid value" }}, valid_session
        assigns(:sample).should be_a_new(Sample)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested sample" do
        ...
        Sample.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => sample.to_param, :sample => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the sample as @sample" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Sample.any_instance.stub(:save).and_return(false)
        put :update, {:id => sample.to_param, :sample => { "name" => "invalid value" }}, valid_session
        assigns(:sample).should eq(sample)
      end
